...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dayOfWeek = substr(date('l', strtotime($date)), 0,3); // Get the first three characters of the day
    $faculties = getFacultiesForOneDay($dayOfWeek, $session, $num, $date); // Function to fetch data
